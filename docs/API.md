...
- [AnyReference](#fxtype-aliasesanyreferencemd)
...
[splitSheetRange](#fxfunctionssplitsheetrangemd) declines to divide such a scope.
...
```ts
function splitSheetRange(ref: string | AnyReference): [string, string];
```
...
| Parameter | Type | Description |
| ------ | ------ | ------ |
| `ref` | `string` \| [`AnyReference`](#fxtype-aliasesanyreferencemd) | A parsed reference, or the sheet scope of one, unquoted. |

## Returns

\[`string`, `string`\]

The two sheet names, unquoted as the scope was, or `undefined` when there is no sheet
...
<a name="fxtype-aliasesanyreferencemd"></a>
...
Re-exports [AnyReference](#fxtype-aliasesanyreferencemd)
...
[splitSheetRange](#fxfunctionssplitsheetrangemd) declines to divide it. See [Prefixes.md](./Prefixes.md).
