...
import {
  FX_PREFIX, UNKNOWN,
  OPERATOR, BOOLEAN, ERROR, NUMBER, FUNCTION, WHITESPACE,
  STRING, PATH_PREFIX, PATH_QUOTE, PATH_BRACE,
  RANGE, RANGE_BEAM, RANGE_NAMED, RANGE_PART
} from './constants.js';
...
test('tokenize partial ranges', t => {
  const opts = { allowPartials: true };
  t.isTokens('1:D$1', [
    { type: RANGE_PART, value: '1:D$1' }
  ], opts);
  ...
  t.isTokens('=A10:A+B1:2', [
    { type: FX_PREFIX, value: '=' },
    { type: RANGE_PART, value: 'A10:A' },
    { type: OPERATOR, value: '+' },
    { type: RANGE_PART, value: 'B1:2' }
  ], opts);
  t.isTokens('=SUM(A:A$10,3:B$2)', [
    { type: FX_PREFIX, value: '=' },
    { type: FUNCTION, value: 'SUM' },
    { type: OPERATOR, value: '(' },
    { type: RANGE_PART, value: 'A:A$10' },
    { type: OPERATOR, value: ',' },
    { type: RANGE_PART, value: '3:B$2' },
    { type: OPERATOR, value: ')' }
  ], opts);
  t.isTokens('$A$10:$12', [
    { type: RANGE_PART, value: '$A$10:$12' }
  ], opts);
  t.isTokens('1:D$1', [
    { type: RANGE_PART, value: '1:D$1' }
  ], opts);
  ...
  t.isTokens('=[foo]Bar!A:A1', [
    { type: FX_PREFIX, value: '=' },
    { type: PATH_BRACE, value: '[foo]' },
    { type: PATH_PREFIX, value: 'Bar' },
    { type: OPERATOR, value: '!' },
    { type: RANGE_PART, value: 'A:A1' }
  ], { mergeRanges: false, allowPartials: true });
