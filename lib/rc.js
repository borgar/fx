 ...
 * @private
 * @see parseR1C1Ref
 * @param {import('./extraTypes.js').RangeR1C1} range  A range object
 ...
 * @returns {(import('./extraTypes.js').RangeR1C1|null)} An object representing a valid reference or null if it is invalid.
 */
export function fromR1C1 (rangeString) {
  /** @type {import('./extraTypes.js').RangeR1C1|null} */
  let final = null;
 ...
 * @returns {(import('./extraTypes.js').ReferenceR1C1|null)} An object representing a valid reference or null if it is invalid.
 */
 ...
 * ```
 *
 * @param {import('./extraTypes.js').ReferenceR1C1} refObject A reference object
 * @param {object} [options={}]  Options
 * @param {boolean} [options.xlsx=false]  Switches to the `[1]Sheet1!A1` or `[1]!name` prefix syntax form for external workbooks. See: [Prefixes.md](./Prefixes.md)
