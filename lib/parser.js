...
function infix (id, bp, led) {
  ...
  s.led = led || /** @this {import('./extraTypes.js').Token} */function (left) {
    this.type = BINARY;
...
function prefix (id, nud) {
  const s = symbol(id);
  s.nud = nud || /** @this {import('./extraTypes.js').Token} */function () {
    this.type = UNARY;
    this.operator = this.value;
    delete this.value;
...
function rangeInfix (id, bp) {
  return infix(id, bp, /** @this {import('./extraTypes.js').Token} */function (left) {
...
postfix('%'); // percent
postfix('#', /** @this {import('./extraTypes.js').Token} */function (left) { // spilled range (_xlfn.ANCHORARRAY)
  if (!isReferenceNode(left)) {
...
infix('(', 90, /** @this {import('./extraTypes.js').Token} */function (left) {
  let callee = {
    type: IDENTIFIER,
    name: left.value
  };
...
/** @this {import('./extraTypes.js').Token} */
...
symbol('}');
symbol(';');
prefix('{', /** @this {import('./extraTypes.js').Token} */function () {
 ...
 *
 * @see nodeTypes
 * @param {(string | import('./extraTypes.js').Token[])} formula An Excel formula string (an Excel expression) or an array of tokens.
 ...
 * @returns {import('./astTypes.js').AstExpression} An AST of nodes
 */
