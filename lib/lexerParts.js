...
function lexRange (str, options) {
  ...
  if (options.r1c1) {
    ...
    // A1 notation
    if ((m = re_A1COL.exec(str)) || (m = re_A1ROW.exec(str))) {
      t = { type: RANGE_BEAM, value: m[0] };
    }
...
export const lexers = [
  ...
  makeHandler(PATH_QUOTE, re_PATH_QUOTE),
  makeHandler(PATH_BRACE, re_PATH_BRACE),
  makeHandler(PATH_PREFIX, re_PATH_PREFIX),
  lexRange,
