import { PATH_BRACE, PATH_PREFIX, PATH_QUOTE, RANGE, RANGE_NAMED, RANGE_BEAM, RANGE_PART, OPERATOR } from './constants.js';
...
const validRunsMerge = [
  ...
  [ RANGE_BEAM ],
  [ RANGE_PART ],
  [ PATH_QUOTE, '!', RANGE, ':', RANGE ],
  [ PATH_QUOTE, '!', RANGE ],
  [ PATH_QUOTE, '!', RANGE_BEAM ],
  [ PATH_QUOTE, '!', RANGE_PART ],
  [ PATH_PREFIX, '!', RANGE, ':', RANGE ],
  [ PATH_PREFIX, '!', RANGE ],
  [ PATH_PREFIX, '!', RANGE_BEAM ],
  [ PATH_PREFIX, '!', RANGE_PART ],
  [ PATH_BRACE, PATH_PREFIX, '!', RANGE, ':', RANGE ],
  [ PATH_BRACE, PATH_PREFIX, '!', RANGE ],
  [ PATH_BRACE, PATH_PREFIX, '!', RANGE_BEAM ],
  [ PATH_BRACE, PATH_PREFIX, '!', RANGE_PART ],
  [ RANGE_NAMED ],
  [ PATH_PREFIX, '!', RANGE_NAMED ],
  [ PATH_BRACE, '!', RANGE_NAMED ], // not strictly legit?
  [ PATH_QUOTE, '!', RANGE_NAMED ]
];
