import { CONTEXT, CONTEXT_QUOTE, RANGE, RANGE_NAMED, RANGE_BEAM, RANGE_TERNARY, OPERATOR, RANGE_STRUCT } from './constants.js';
...
const validRunsMerge = [
  ...
  [ RANGE_STRUCT ],
  [ RANGE_NAMED, RANGE_STRUCT ],
  [ CONTEXT, '!', RANGE_NAMED, RANGE_STRUCT ],
  [ CONTEXT_QUOTE, '!', RANGE_NAMED, RANGE_STRUCT ]
];
