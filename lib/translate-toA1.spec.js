...
test('translate out of bounds coords from RC to A1', t => {
  ...
  const tokens = addMeta(tokenize('SUM(Sheet1!R[-1]C[-1])', { r1c1: true, emitRanges: true }));
  t.deepEqual(translateToA1(tokens, 'A1', { wrapEdges: false }), [
    { type: FUNCTION, value: 'SUM', range: [ 0, 3 ], index: 0, depth: 0 },
    { type: OPERATOR, value: '(', range: [ 3, 4 ], index: 1, depth: 1, groupId: 'fxg1' },
    { type: ERROR, value: '#REF!', range: [ 4, 9 ], index: 2, depth: 1 },
    { type: OPERATOR, value: ')', range: [ 9, 10 ], index: 3, depth: 1, groupId: 'fxg1' }
  ], 'tokens with meta');
  ...
  t.is(translateToA1(f3, 'B2', { wrapEdges: false, mergeRanges: false }), '=Sheet4!#REF!:A1', f3);
...
test('translate works with merged ranges', t => {
  ...
  const expected = [
    ...
    { type: REF_RANGE, value: 'E10', range: [ 8, 11 ], index: 5, depth: 2 },
    { type: OPERATOR, value: ',', range: [ 11, 12 ], index: 6, depth: 2 },
    { type: REF_RANGE, value: '$E$2', range: [ 12, 16 ], index: 7, depth: 2 },
    { type: OPERATOR, value: ',', range: [ 16, 17 ], index: 8, depth: 2 },
    { type: REF_RANGE, value: '$E$3', range: [ 17, 21 ], index: 9, depth: 2 },
    { type: OPERATOR, value: ')', range: [ 21, 22 ], index: 10, depth: 2, groupId: 'fxg1' },
    { type: OPERATOR, value: ',', range: [ 22, 23 ], index: 11, depth: 1 },
    { type: REF_BEAM, value: 'Sheet1!$2:$2', range: [ 23, 35 ], index: 12, depth: 1, groupId: 'fxg2' },
    { type: OPERATOR, value: '*', range: [ 35, 36 ], index: 13, depth: 1 },
    { type: REF_BEAM, value: 'Sheet2!B:B', range: [ 36, 46 ], index: 14, depth: 1 },
