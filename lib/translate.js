...
export function translateToRC (fx, anchorCell) {
  ...
  const tokens = isString
    ? tokenize(fx, { emitRanges: false, mergeRanges: false, allowPartials: true, r1c2: false })
    : fx;
...
export function translateToA1 (fx, anchorCell) {
  ...
  const tokens = isString
    ? tokenize(fx, { emitRanges: false, mergeRanges: false, allowPartials: true, r1c1: true })
    : fx;
