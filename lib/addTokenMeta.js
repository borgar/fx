 ...
 *
 * @param {Array<import('./extraTypes.js').Token>} tokenlist An array of tokens (from `tokenize()`)
 ...
 * @returns {Array<import('./extraTypes.js').TokenEnhanced>} The input array with the enchanced tokens
 */
