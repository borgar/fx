...
Test.prototype.okayRoundTrip = function roundTrip (expr, anchor) {
  const rc = translateToR1C1(expr, anchor);
  const a1 = translateToA1(rc, anchor);
