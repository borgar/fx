...
test('A1 trimmed ranges', t => {
  ...
  for (const opt of opts) {
    ...
    t.isA1Equal('A1.:B2', { range: { top: 0, left: 0, bottom: 1, right: 1, trimTL: true } }, opt);
    t.isA1Equal('A1:.B2', { range: { top: 0, left: 0, bottom: 1, right: 1, trimBR: true } }, opt);
    t.isA1Equal('A1.:.B2', { range: { top: 0, left: 0, bottom: 1, right: 1, trimTL: true, trimBR: true } }, opt);

    t.isA1Equal('$A$1:$B$2', { range: { top: 0, left: 0, bottom: 1, right: 1, ...locks } }, opt);
    t.isA1Equal('$A$1.:$B$2', { range: { top: 0, left: 0, bottom: 1, right: 1, trimTL: true, ...locks } }, opt);
    t.isA1Equal('$A$1:.$B$2', { range: { top: 0, left: 0, bottom: 1, right: 1, trimBR: true, ...locks } }, opt);
    t.isA1Equal('$A$1.:.$B$2', { range: { top: 0, left: 0, bottom: 1, right: 1, trimTL: true, trimBR: true, ...locks } }, opt);

    t.isA1Equal('J:J', { range: { top: null, left: 9, bottom: null, right: 9 } }, opt);
    t.isA1Equal('J.:J', { range: { top: null, left: 9, bottom: null, right: 9, trimTL: true } }, opt);
    t.isA1Equal('J:.J', { range: { top: null, left: 9, bottom: null, right: 9, trimBR: true } }, opt);
    t.isA1Equal('J.:.J', { range: { top: null, left: 9, bottom: null, right: 9, trimTL: true, trimBR: true } }, opt);

    t.isA1Equal('10:10', { range: { top: 9, left: null, bottom: 9, right: null } }, opt);
    t.isA1Equal('10.:10', { range: { top: 9, left: null, bottom: 9, right: null, trimTL: true } }, opt);
    t.isA1Equal('10:.10', { range: { top: 9, left: null, bottom: 9, right: null, trimBR: true } }, opt);
    t.isA1Equal('10.:.10', { range: { top: 9, left: null, bottom: 9, right: null, trimTL: true, trimBR: true } }, opt);
    ...
    t.isA1Equal('J10.:.J', { range: { top: 9, left: 9, bottom: null, right: 9, trimTL: true, trimBR: true } }, { allowTernary: true, ...opt });
    t.isA1Equal('J10.:.10', { range: { top: 9, left: 9, bottom: 9, right: null, trimTL: true, trimBR: true } }, { allowTernary: true, ...opt });
  }
  t.end();
});
...
test('A1 serialization', t => {
  ...
  // triming
  t.is(toA1({ top: 2, bottom: 2, left: 4, right: 4, trimTL: true, trimBR: true }), 'E3', 'E3');
  t.is(toA1({ top: 2, bottom: 3, left: 4, right: 6, trimTL: true, trimBR: true }), 'E3.:.G4', 'E3.:.G4');
  t.is(toA1({ top: 2, bottom: 3, trimTL: true, trimBR: true }), '3.:.4', '3.:.4');
  t.is(toA1({ left: 4, right: 6, trimTL: true, trimBR: true }), 'E.:.G', 'E.:.G');
  t.is(toA1({ top: 9, left: 0, right: 0, trimBR: true }), 'A10:.A', 'A10:.A');
  t.is(toA1({ top: 9, left: 0, right: 0, trimTL: true }), 'A10.:A', 'A10.:A');
  t.is(toA1({ top: 9, left: 0, right: 0, trimTL: true, trimBR: true }), 'A10.:.A', 'A10.:.A');
