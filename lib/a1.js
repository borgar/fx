 ...
 * @ignore
 * @see parseA1Ref
 * @param {import('./extraTypes.js').RangeA1} range  A range object
 ...
 * @returns {(import('./extraTypes.js').ReferenceA1|null)} An object representing a valid reference or null if it is invalid.
 */
 ...
 * ```
 *
 * @param {import('./extraTypes.js').ReferenceA1} refObject A reference object
 * @param {object} [options={}]  Options
 * @param {boolean} [options.xlsx=false]  Switches to the `[1]Sheet1!A1` or `[1]!name` prefix syntax form for external workbooks. See: [Prefixes.md](./Prefixes.md)
 ...
 * ```
 *
 * @param {import('./extraTypes.js').RangeA1} range The range part of a reference object.
 * @returns {import('./extraTypes.js').RangeA1} same range with missing bounds filled in.
 */
