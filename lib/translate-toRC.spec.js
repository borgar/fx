...
test('translate works with merged ranges', t => {
  ...
  const expected = [
    ...
    { type: REF_RANGE, value: 'RC[1]', range: [ 8, 13 ], index: 5, depth: 2, groupId: 'fxg1' },
    { type: OPERATOR, value: ',', range: [ 13, 14 ], index: 6, depth: 2 },
    { type: REF_RANGE, value: 'R2C5', range: [ 14, 18 ], index: 7, depth: 2, groupId: 'fxg2' },
    { type: OPERATOR, value: ',', range: [ 18, 19 ], index: 8, depth: 2 },
    { type: REF_RANGE, value: 'R3C5', range: [ 19, 23 ], index: 9, depth: 2, groupId: 'fxg3' },
    { type: OPERATOR, value: ')', range: [ 23, 24 ], index: 10, depth: 2, groupId: 'fxg4' },
    { type: OPERATOR, value: ',', range: [ 24, 25 ], index: 11, depth: 1 },
    { type: REF_BEAM, value: 'Sheet1!R2', range: [ 25, 34 ], index: 12, depth: 1, groupId: 'fxg5' },
    { type: OPERATOR, value: '*', range: [ 34, 35 ], index: 13, depth: 1 },
    { type: REF_BEAM, value: 'Sheet2!C[-2]', range: [ 35, 47 ], index: 14, depth: 1, groupId: 'fxg6' },
